1. đầu tiên ae mở 2 window vscode, 1 window thì mở 1 folder nodejs với reactjs
2. xong ae vào từng window gõ lệnh npm install, nó hiện lỗi gì thì ae hỏi chatgpt tự xử lý nha
3. xong ae chạy npm start, tôi cũng không biết lỗi như nào nên ae hỏi chatgpt xử lý hoặc tải gì cần thiết nha:D
4. về phần cơ sở dữ liệu thì tôi dùng xampp, ae dùng gì thì cứ chạy lên thử xem có được không. xong dùng lệnh npx sequelize-cli db:migrate để tạo bảng trong database
5. Sau khi insert có bảng xong thì ae vào database nhấn vào bảng allcodes vào phần sql xong paste phần này vào:  INSERT INTO ALLCODES (ALLCODES.type,ALLCODES.keyMap, ALLCODES.valueEn, ALLCODES.valueVi) values ('ROLE','R1','Admin', 'Quản trị viên' ); 
INSERT INTO ALLCODES (ALLCODES.type,ALLCODES.keyMap, ALLCODES.valueEn, ALLCODES.valueVi) values ('ROLE','R2','Doctor', 'Bác sĩ' ); 
INSERT INTO ALLCODES (ALLCODES.type,ALLCODES.keyMap, ALLCODES.valueEn, ALLCODES.valueVi) values ('ROLE','R3','Patient', 'Bệnh nhân' ); 
...
INSERT INTO ALLCODES (ALLCODES.type,ALLCODES.keyMap, ALLCODES.valueEn, ALLCODES.valueVi) values ('STATUS','S3','Done', 'Đã khám xong' ); 
...
xong ctrl + a ( bôi đen hết ) xong ctrl + enter 
